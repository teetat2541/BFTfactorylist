...
<div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
            ...
            <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    <h2 className="text-xl text-white">บริษัท บุตรฟ้าทอง จำกัด</h2>
                    <p className="text-sm text-gray-300 mt-4">BUTR FAH THONG COMPANY LIMITED</p>
                    ...
                    <ul className="mt-16 space-y-8">
                        ...
                        <li className="flex items-center">
                            ...
                            <Link href="https://maps.app.goo.gl/f9LbFK2sDWB7eD2bA" target="_blank" className="text-white text-sm text-gray-500 ml-4">
                                7 ถ. บางบอน 3 บางบอนเหนือ เขตบางบอน กรุงเทพมหานคร 10150
                            </Link>
                        </li>
                    </ul>
                    <ul className="flex flex-wrap gap-4 mt-16">
                        ...
                        <Link href="https://lin.ee/b63USM2" target="_blank"><img title="contact" width={50} src="https://www.svgrepo.com/show/452049/line.svg" ></img></Link>
                        </li>
                    </ul>
                </div>
            </div>
            <div className="z-10 relative h-full max-md:min-h-[350px]">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3877.101483377825!2d100.38286057374467!3d13.65159029960846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2bdacdbb6c08f%3A0x3585c7cd76543b01!2z4Lia4LiI4LiBLuC4quC4uOC4p-C4o-C4o-C4k-C4muC4uOC4leC4oyAoU1VXQU5CVVRSIENPLixMVEQp!5e0!3m2!1sth!2sth!4v1718853899607!5m2!1sth!2sth"
              title="map"
